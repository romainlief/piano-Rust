...
pub fn matching_key_pressed(
    ...
    match key {
        ...
        Keycode::Key1 => {
            ...
            frequency_manager::add_frequency_realtime(&active_frequencies, consts::constants::ASharp4);
        }
        Keycode::Key2 => {
            println!(
            ...
            frequency_manager::add_frequency_realtime(&active_frequencies, consts::constants::CSharp5);
        }
        Keycode::Key3 => {
            println!(
            ...
            frequency_manager::add_frequency_realtime(&active_frequencies, consts::constants::DSharp5);
        }
        Keycode::Key4 => {
            println!(
            ...
            frequency_manager::add_frequency_realtime(&active_frequencies, consts::constants::FSharp5);
        }
        Keycode::Key5 => {
            println!(
            ...
            frequency_manager::add_frequency_realtime(&active_frequencies, consts::constants::GSharp5);
        }
        Keycode::Space => {
...
pub fn matching_key_released(key: Keycode, active_frequencies: &Arc<Mutex<HashSet<u64>>>) {
    match key {
        Keycode::Q => {
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::A4);
        }
        Keycode::B => {
            println!("Touche B relâchée - fréquence: {}", consts::constants::B4);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::B4);
        }
        Keycode::C => {
            println!("Touche C relâchée - fréquence: {}", consts::constants::C5);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::C5);
        }
        Keycode::D => {
            println!("Touche D relâchée - fréquence: {}", consts::constants::D5);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::D5);
        }
        Keycode::E => {
            println!("Touche E relâchée - fréquence: {}", consts::constants::E5);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::E5);
        }
        Keycode::F => {
            println!("Touche F relâchée - fréquence: {}", consts::constants::F5);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::F5);
        }
        Keycode::G => {
            println!("Touche G relâchée - fréquence: {}", consts::constants::G5);
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::G5);
        }
        Keycode::Key1 => {
            println!(
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::ASharp4);
        }
        Keycode::Key2 => {
            println!(
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::CSharp5);
        }
        Keycode::Key3 => {
            println!(
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::DSharp5);
        }
        Keycode::Key4 => {
            println!(
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::FSharp5);
        }
        Keycode::Key5 => {
            println!(
            ...
            frequency_manager::remove_frequency_realtime(&active_frequencies, consts::constants::GSharp5);
        }
        _ => {}
    }
}
